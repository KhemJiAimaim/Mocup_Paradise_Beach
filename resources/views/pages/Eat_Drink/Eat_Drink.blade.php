    ...
    <section class=" w-full h-auto relative z-50">
        <div
            ...
            <div class="flex flex-col sm:gap-y-8 border-4 border-[#03203E] md:p-12 p-6 md:w-[60%] w-full">
                <div class="xl:text-8xl text-4xl capitalize text-white text-center font-[700] ss:tracking-[8px] tracking-widest animate__animated animate__zoomIn" style="text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.7);">
                    Eat & Drink
                </div>
            </div>
        </div>
