...
@section('contents')
    <section class=" w-full h-auto relative z-50">
        ...
        <div class="relative w-full h-[500px] max-2xl:h-[400px] max-lg:h-[250px] max-md:h-[150px]">
            <img src="/images/spa/Head-slide-5.jpg" alt="Banner Image" class="w-full h-full object-cover">
    ...
    <div class="lg:py-16 py-[30px]">
        ...
        <section class="w-full overflow-hidden md:mt-16 mt-[30px] relative">
            <div
                ...
                <div class="flex flex-col sm:gap-y-8 md:border-l-[50px] border-l-[20px] border-[#025370] ss:p-12 p-6 xl:w-[60%] md:w-[80%] w-full  bg-slate-50 top-1/2 left-1/2"
                    data-aos="zoom-in" data-aos-duration="800">

                    <div
                        class="w-full h-auto flex flex-col xl:gap-12 lg:gap-8 gap-4 justify-start items-start lg:p-6 md:p-2 ">
                        <div class="flex flex-col gap-2">
                            <span class="ss:text-3xl text-2xl font-kanit text-[#03203E] tracking-widest capitalize">Spa
                                treatments</span>
            ...
            <div class="relative w-full h-[700px] max-2xl:h-[650px] max-lg:h-[450px]">
                <img src="/images/spa/spa-1.jpg" alt="Banner Image" class="w-full h-full object-cover">
        ...
        <section class="z-50 px-4 max-w-[1536px] m-auto overflow-hidden">
            ...
            @php
                ...
                $img = ['/images/spa/Gallery-12.jpg', '/images/spa/Index-5.jpg', '/images/spa/Index-4.jpg'];
            @endphp
            ...
            <div class="max-w-[1320px] m-auto" data-aos="fade-up" data-aos-duration="500">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="bg-[#025370] absolute left-0 top-0 w-[90%] xl:h-[500px] lg:h-[400px] h-[340px] z-[1]">
                        </div>
                    ...
                    <div
                        ...
                        <p
                            class="xl:text-6xl lg:text-3xl md:text-2xl text-xl font-prata text-gray-600 font-[700] ss:tracking-[8px] tracking-widest">
                            wellness retreats
                        </p>

                        <p class="text-gray-600 md:text-lg text-base ">Lorem ipsum dolor sit amet consectetur
                            adipisicing
                            elit.
                            Quibusdam, delectus consequatur similique alias
                            perferendis Lorem ipsum dolor sit amet consectetur adipisicing elit.
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-2">
                            <span class="lg:text-3xl md:text-2xl text-xl font-kanit text-[#03203E] tracking-widest">Gym
                                Membership</span>
                            <div class="border-t-2 border-gray-400 max-w-[3rem] w-full rounded-full"></div>
                        </div>
                        <p
                    ...
                    <div
                        ...
                        <div class="bg-[#025370] left-0 top-0 absolute w-[90%] xl:h-[500px]  lg:h-[400px] h-[340px] z-[1]">
                        </div>
                ...
                <div
                    ...
                    <div
                        class="w-full h-auto flex flex-col xl:gap-12 lg:gap-8 gap-4 justify-start items-start lg:p-16 md:p-2">
                        <div class="flex flex-col gap-2">
                            <span class="md:text-3xl text-2xl font-kanit text-[#03203E] tracking-widest ">Salt
                                Chlorinator</span>
                            <div class="border-t-2 border-gray-400 max-w-[3rem] w-full rounded-full"></div>
                        </div>
                        <p
                            class="xl:text-6xl md:text-3xl text-2xl font-prata text-gray-600 font-[700] ss:tracking-[8px] tracking-widest">
                            Ozone system
                        </p>
